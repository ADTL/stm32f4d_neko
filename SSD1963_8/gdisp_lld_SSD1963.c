...
LLDSPEC bool_t gdisp_lld_init(GDisplay *g) {
	...
	write_data(g, 0x22);								// PLLclk = REFclk (10Mhz) * 36 (360Mhz)
	write_data(g, 0x03);								// SYSclk = PLLclk / 3  (120MHz)
	write_data(g, 0x04);								// Apply calculation bit, else it is ignored
